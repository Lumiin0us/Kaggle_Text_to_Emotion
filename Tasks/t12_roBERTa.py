...
# Calculate BERT embeddings for each record or tweet of our sentiment (cat_1, cat_2) and store them in "sentiment_vector_map"
def calculate_roberta_embeddings_for_each_record(cat_1, cat_2):
...
def calculate_roberta_embeddings_for_overall_list(cat_1, cat_2):
    sentiment_vector_map = {}
...
def record_based_similarity_between_each_pair(all_sentiments):
    ...
    for pairs in combinations(all_sentiments, 2):
        bert_embeddings_words = calculate_roberta_embeddings_for_each_record(pairs[0], pairs[1])
        bert_embeddings_list, cat_1, cat_2 = calculate_roberta_embeddings_for_overall_list(pairs[0], pairs[1])
